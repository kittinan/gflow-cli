...
| **3. Dimensions (t2i)** | Pillow: `JPEG (1024, 1024) RGB`, 776 KB — `0754aa44…_1.jpg` | 🟢 PASS |
...
| **5. Character face asset** | `ff d8 ff e0` — Pillow `JPEG (1376, 768) RGB`, 556 KB — `character_da3cd647…_slot0.jpg` | 🟢 PASS |
